...
passport.use(new facebookStrategy({
	...
	db.user.findOne({
		...
		if(existingUser && facebookEmail){
			...
			// The person is just new meaning we will need to create an entry for them in the users table
			// Parse users name before enter into database
			...
			db.user.findOrCreate({
				...
				if(wasCreated){
					...
					// They were not new after all, we just need to update the token for a new login session 
